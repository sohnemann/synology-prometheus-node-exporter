...
curl -fsS -H 'Cache-Control: no-cache' https://raw.githubusercontent.com/merc1031/synology-prometheus/master/docker-compose.yml > ${PROMETHEUS_ROOT}/docker-compose.yml
