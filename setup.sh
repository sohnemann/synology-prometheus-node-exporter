...
curl -fsS -H 'Cache-Control: no-cache' https://raw.githubusercontent.com/sohnemann/synology-prometheus-node-exporter/master/docker-compose.yml > ${PROMETHEUS_ROOT}/docker-compose.yml
